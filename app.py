...
# --- 2. OFERTA ACADÉMICA CALIFICADA TOTAL (10 CAMPOS POR FILA) ---
O_TOTAL = [
    # Tópicos de Economía Digital (525) - ¡NUEVA!
    [525, "DPTO. ECONOMÍA", "Coll Agustin Julian", "Ma / Vi", "17-19", "Córdoba", 140.0, 900000, "P", ""],

    # Microeconomía I (290) - RESTAURADA
    ...
    # Historia Económica Arg. (541) - RESTAURADA
    ...
    # Análisis Estadístico (540) - RESTAURADA
    ...
    [540, "CAVIEZEL", "Trajtenberg Luis", "Lu / Mi / Ju", "07-09", "Córdoba", 144.0, 914595, "P", ""],
    ...
    [559, "LOPEZ ANDRES", "Ronconi Lucas", "Lu / Ju", "09-00", "Córdoba", 175.7, 909000, "P", ""],
    [559, "SIRLIN PABLO", "Sirlin Pablo", "Ma / Vi", "17-19", "Córdoba", 175.7, 909007, "P", ""],
...
saved = cookies.get("fce_v_final_economy_v10")
if saved:
...
with st.sidebar:
    ...
    if st.button("💾 GUARDAR DATOS"):
        ...
        cookie_manager.set("fce_v_final_economy_v10", json.dumps(data))
        st.success("Guardado.")
...
tab_sel, tab_suggest = st.tabs(["📝 Selección", "📋 Sugerencia de Inscripción"])
                ...
                for idx, c in enumerate(combo):
                    ...
                    with cols[idx]:
                        ...
                        <div class="materia-card">
                            ...
                            <div style="font-size:0.85em; color:#64748B; font-weight:700;">CÁTEDRA: {c[1]}</div>
